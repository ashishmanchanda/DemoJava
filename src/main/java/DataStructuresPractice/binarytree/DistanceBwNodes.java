...
class DistanceBwNodes {
    public int data;
    public DistanceBwNodes left, right;

    DistanceBwNodes(int val) {
        data = val;
        left = null;
        right = null;
    }
...
class DistanceNodes {
    ...
    static int findLevel(DistanceBwNodes root, int k, int level) {
    ...
    static DistanceBwNodes findLcaAndDistance(DistanceBwNodes root, int a, int b,
        ...
        // Recursively call function on left child
        DistanceBwNodes left = findLcaAndDistance
                (root.left, a, b, d1, d2, dist, lvl + 1);

        // Recursively call function on right child
        DistanceBwNodes right = findLcaAndDistance
    ...
    static int findDist(DistanceBwNodes root, int a, int b) {
        int[] d1 = {-1}, d2 = {-1}, dist = {0};

        // Find lowest common ancestor and calculate distance
        DistanceBwNodes lca = findLcaAndDistance(root, a, b, d1, d2, dist, 1);
    ...
    public static void main(String[] args) {
        ...
        DistanceBwNodes root = new DistanceBwNodes(1);
        root.left = new DistanceBwNodes(2);
        root.right = new DistanceBwNodes(3);
        root.left.left = new DistanceBwNodes(4);
        root.left.right = new DistanceBwNodes(5);
        root.right.left = new DistanceBwNodes(6);
        root.right.right = new DistanceBwNodes(7);
