...
//    ChildrenSumTreeNode left;        // Pointer to left child
//    ChildrenSumTreeNode right;       // Pointer to right child
//
//    // Constructor to initialize node with a given value
//    ChildrenSumTreeNode(int x) {
//        val = x;
//        left = null;
//        right = null;
//    }
...
//    public List<List<Integer>> zigzagLevelOrder(ChildrenSumTreeNode root) {
...
//        Queue<ChildrenSumTreeNode> q = new LinkedList<>();
//        q.offer(root);
//
...
//                ChildrenSumTreeNode node = q.poll();
//
...
//        //    / \     \
//        //   4   5     6
//        ChildrenSumTreeNode root = new ChildrenSumTreeNode(1);
//        root.left = new ChildrenSumTreeNode(2);
//        root.right = new ChildrenSumTreeNode(3);
//        root.left.left = new ChildrenSumTreeNode(4);
//        root.left.right = new ChildrenSumTreeNode(5);
//        root.right.right = new ChildrenSumTreeNode(6);
//
