...
class EOGfG {
    ...
    // Function to segregate even and odd SegregateEvenOddNodes
    // and return the head of the new list.
    public static SegregateEvenOddNode divide(SegregateEvenOddNode head) {

        // We create dummy SegregateEvenOddNodes to avoid extra 
        ...
        // SegregateEvenOddNode to traverse the list
        ...
        while (curr != null) {
            ...
            // Move to the next SegregateEvenOddNode
            curr = curr.next;
        }
    ...
    public static void printList(SegregateEvenOddNode SegregateEvenOddNode) {
        while (SegregateEvenOddNode != null) {
            System.out.print(SegregateEvenOddNode.data + " ");
            SegregateEvenOddNode = SegregateEvenOddNode.next;
        }
    }
