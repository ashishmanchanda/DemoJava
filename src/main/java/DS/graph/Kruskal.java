...
//connected, undirected and weighted Kruskal
import java.util.*;
import java.lang.*;
import java.io.*;
...
class Kruskal {
    ...
    void KruskalMST()
    {
        ...
        // change the given Kruskal, we can create a copy of
        // array of edges
        Arrays.sort(edge);
    ...
    public static void main(String[] args)
    {
		...
		/* Let us create following weighted Kruskal
				10
			0--------1
			| \	 |
		6| 5\ |15
			...
			2--------3
				4	 */
        int V = 4; // Number of vertices in Kruskal
        int E = 5; // Number of edges in Kruskal
