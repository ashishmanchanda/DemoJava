 ...
 class BT_NoParentPtr_Solution1
{
    ...
    // Finds the path from root LCANode to given root of the tree.
    ...
    private int findLCAInternal(LCANode root, int n1, int n2) {
    ...
    // Finds the path from root LCANode to given root of the tree, Stores the
    // path in a vector path[], returns true if path exists otherwise false
    private boolean findPath(LCANode root, int n, List<Integer> path)
    {
        // base case
        if (root == null) {
            return false;
        ...
        // Store this LCANode . The LCANode will be removed if
